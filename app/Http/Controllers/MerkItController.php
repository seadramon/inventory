...
class MerkItController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pages.merk.it.index');
    }

    public function data()
    {
        $query = Merk::where('type','IT')->select('*');
        ...
        return DataTables::eloquent($query)
                ...
                $edit = '<div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="' . route('master.merk.it.edit',  $model->kd_merk) . '">Edit</a></li>
    ...
    {
        return view('pages.merk.it.create');
    }
    ...
    public function store(Request $request, FlasherInterface $flasher)
    {
        ...
        return redirect()->route('master.merk.it.index');
    }
