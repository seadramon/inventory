	...
	<div class="col-12">
		<div class="card card-xl-stretch mb-5 mb-xl-8">
			<div class="card-header">
				<h3 class="card-title">Generate Inventaris IT Qr Code</h3>
			</div>
			{!! Form::open(['url' => route('inventaris-it.qrcode'), 'class' => 'form', 'id' => 'f_qrcode', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
			<div class="card-body">
				<div class="row">
					<div class="col-12">
