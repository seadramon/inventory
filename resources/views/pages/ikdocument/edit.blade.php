		...
		<div class="post d-flex flex-column-fluid" id="kt_post">
			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<!--begin::Form-->
					@if (isset($data))
	                    {!! Form::model($data, ['url' => route('ikdocument.update', ['ikdocument' => $data->id]), 'class' => 'form', 'id' => 'kt_project_settings_form', 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
	                @else
	                ...
	                @endif
						...
						<div class="card-body p-9">
							...
							<div class="form-group">
								<label class="fs-6 fw-bold mt-2 mb-3">Upload Dokumen IK</label>
								{!! Form::file('doc', ['class'=>'form-control', 'accept' => '.pdf']) !!}
